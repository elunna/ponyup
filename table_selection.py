...
tables = (
    ...
    Game('Rainbow Factory', seats=8, level=6, game="FIVE CARD DRAW"),
    ...
    Game('Wonderbolt Academy', seats=8, level=6, game="FIVE CARD DRAW"),
    Game('Mirror Pool', seats=8, level=7, game="FIVE CARD DRAW"),
    ...
    Game('Mount Everhoof', seats=8, level=4, game="FIVE CARD STUD"),
    Game('Ghastly Gorge', seats=8, level=5, game="FIVE CARD STUD"),
    ...
    Game('Hollow Shades', seats=8, level=6, game="FIVE CARD STUD"),
    ...
    Game('Dodge Junction', seats=8, level=5, game="FIVE CARD STUD"),
    Game('Tenochtitlan Basin', seats=6, level=6, game="FIVE CARD STUD"),
    Game('Tartarus', seats=8, level=7, game="FIVE CARD STUD"),
)
